...
class RoomPanoramaView(TemplateView):
    """
    部屋パノラマ
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        self.panorama = get_object_or_404(RoomPanorama, pk=panorama_id)
        self.panorama.room.building.auth_user = self.user
    ...
    def get_context_data(self, **kwargs):
        ...
        context['building'] = self.panorama.room.building
        context['room'] = self.panorama.room
